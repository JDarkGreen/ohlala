...
function create_post_type(){
	...
	$labels_catalogo = array(
		'name'               => __('Catálogos'),
		'singular_name'      => __('Catálogo'),
		'add_new'            => __('Nuevo Catálogo'),
		'add_new_item'       => __('Agregar nuevo Catálogo'),
		'edit_item'          => __('Editar Catálogo'),
		'view_item'          => __('Ver Catálogo'),
		'search_items'       => __('Buscar Catálogo'),
		'not_found'          => __('Catálogo no encontrado'),
		'not_found_in_trash' => __('Catálogo no encontrado en la papelera'),
	);

	$args_catalogo = array(
		'labels'      => $labels_catalogo,
		'has_archive' => true,
		'public'      => true,
		'hierachical' => false,
		'supports'    => array('title','editor','excerpt','custom-fields','thumbnail','page-attributes' ),
	...
	#CATALOGOS
	register_post_type( 'theme-catalogos' , $args_catalogo );
